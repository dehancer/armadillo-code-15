...
class op_norm
  ...
  template<typename eT> arma_hot inline static eT                    vec_norm_1_direct_std(const Mat<eT>& X, const typename arma_real_fullprec_only<eT>::result* junk = nullptr);
  template<typename eT> arma_hot inline static eT                    vec_norm_1_direct_std(const Mat<eT>& X, const typename  arma_real_lowprec_only<eT>::result* junk = nullptr);
  ...
  template<typename eT> arma_hot inline static eT                    vec_norm_2_direct_std(const Mat<eT>& X, const typename arma_real_fullprec_only<eT>::result* junk = nullptr);
  template<typename eT> arma_hot inline static eT                    vec_norm_2_direct_std(const Mat<eT>& X, const typename  arma_real_lowprec_only<eT>::result* junk = nullptr);
